// ============================================================
// Submitted Case meta — Revision Management, Integration status, Case Health.
// Bổ sung metadata cho Submitted Case Workspace (Sprint 2.5). Không đụng Core.
// ============================================================
window.BANCA = window.BANCA || {};

// Vòng đời revision + so sánh V1↔V2 (demo cho hồ sơ có bổ sung)
BANCA.CASE_META = {
  'APP-2026-104': {
    currentVersion:2,
    versions:[
      {v:1, label:'V1 · Submitted', at:'2026-07-16 09:40', status:'SUBMITTED'},
      {v:2, label:'V2 · Supplement', at:'2026-07-18 16:45', status:'NEED_MORE_INFORMATION'}
    ],
    lifecycle:['Draft','Submitted V1','Need Supplement','Submitted V2','Underwriting'],
    compare:[
...
BANCA.caseMeta = id => BANCA.CASE_META[id] || {currentVersion:1, versions:[{v:1,label:'V1 · Submitted',at:'—',status:'SUBMITTED'}], lifecycle:['Draft','Submitted V1'], compare:[]};

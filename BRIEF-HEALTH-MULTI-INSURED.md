...
- Ghi `HEALTH-MULTI-INSURED-REPORT.md`: file đã sửa + data model InsuredCoverageUnit + journey config + demo seed (1 family app 2-3 người) + root cause + remaining issues.

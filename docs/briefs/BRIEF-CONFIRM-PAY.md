...
- Ghi `docs/reports/CONFIRM-PAY-REPORT.md`: file đã sửa + thay đổi deriveCaseViewState/gating + danh sách demo app đã migrate (before/after state) + root cause + remaining issues.
